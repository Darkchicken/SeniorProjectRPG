...
public class WarriorRunes : MonoBehaviour
{
    ...
    //Rune #1
    private int rune1_SkillSlot = 5;
    private string rune1_Name = "SLAM";
    private string rune1_ID = "WarriorRune_1";
    private string rune1_Info = "";
    private bool rune1_Type = true; 
    private int rune1_ResourceGeneration = 6;
    private int rune1_ResourceUsage = 0;
    private int rune1_AttackRange = 3;
    private float rune1_AttackSpeed = 0.5f;
    private int rune1_Value = 0;

    //Rune #2
    private int rune2_SkillSlot = 5;
    private string rune2_Name = "CARVE";
    private string rune2_ID = "WarriorRune_2";
    private string rune2_Info = "";
    private bool rune2_Type = false;
    private int rune2_ResourceGeneration = 0;
    private int rune2_ResourceUsage = 20;
    private int rune2_AttackRange = 0;
    private float rune2_AttackSpeed = 1f;
    ...
    public static List<Rune> warriorRunes;
    ...
    void Start()
    {
        ...
        warriorRunes = new List<Rune>();
        warriorRunes.Add(new Rune(rune1_SkillSlot, rune1_Name, rune1_ID, rune1_Info, rune1_Type, rune1_ResourceGeneration, rune1_ResourceUsage, rune1_AttackRange, rune1_AttackSpeed, rune1_Value));
        warriorRunes.Add(new Rune(rune2_SkillSlot, rune2_Name, rune2_ID, rune2_Info, rune2_Type, rune2_ResourceGeneration, rune2_ResourceUsage, rune2_AttackRange, rune2_AttackSpeed, rune2_Value));
        warriorRunes.Add(new Rune(rune7_SkillSlot, rune7_Name, rune7_ID, rune7_Info, rune7_Type, rune7_ResourceGeneration, rune7_ResourceUsage, rune7_AttackRange, rune7_AttackSpeed, rune7_Value));
    ...
    public void SLAM()
    {
        if(PlayerCombatManager.targetEnemy != null)
        {
            if (Vector3.Distance(transform.position, PlayerCombatManager.targetEnemy.transform.position) <= rune1_AttackRange)
            {
                ...
                {
                    PlayerCombatManager.targetEnemy.GetComponent<EnemyHealth>().TakeDamage(15);
                    attackTimer = 0f;
